...
public class Staff extends Person{
    ...
    public void removePromotion(String position, String department, Date date){
        for(Promotion p:promotions){
            if(p.getTime().equals(date) && p.getPosition().getName().equalsIgnoreCase(position) && p.getPosition().getDepartment().getName().equalsIgnoreCase(department)){
                promotions.remove(p);
                return;
            }
        }
