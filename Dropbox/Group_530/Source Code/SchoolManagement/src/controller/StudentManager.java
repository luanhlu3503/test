...
public class StudentManager extends Manager implements StudentMng, BatchMng, ExtraCurricularMng, SubjectMng {
    ...
    public int addStudent(Student student) {
        ...
        List<ExtraCurricular> extraCurriculars=student.getExtraCurriculars();
        if(extraCurriculars !=null && extraCurriculars.size()>0){
            for(ExtraCurricular ex:extraCurriculars){
