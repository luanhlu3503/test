...
public class ListStudent extends javax.swing.JInternalFrame implements UIInterface{
    ...
    public void save(){
        ...
        newStudent.getAcademic().setBatch(batchEntity.findByName((String)comboBatch.getSelectedItem()));
...
//        return;
    ...
    public boolean validateForm() {
        if(comboBatch.getSelectedIndex() ==0){
            JOptionPane.showMessageDialog(this, "No is required !");
            return false;
        }
        if(Validate.isEmpty(txtNo.getText())){
            JOptionPane.showMessageDialog(this, "No is required !");
            return false;
        }
        return true;
